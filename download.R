...
end_date<-as.Date("2018-01-01 00:00:00")
...
start_date<-as.Date("2018-01-02 00:00:00")
end_date<-as.Date("2019-01-01 00:00:00")
dates<-seq(start_date,end_date,by="days")
...
start_date<-as.Date("2019-01-02 00:00:00")
end_date<-as.Date("2020-01-01 00:00:00")
dates<-seq(start_date,end_date,by="days")
dates<-as.numeric(as.POSIXct(dates,"UTC",origin = "1970-01-01"))
username<-"kkini1@hawk.iit.edu"
password<-"Kashika3#"
